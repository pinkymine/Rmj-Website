...
// Main Product Listing component for Kids' Pendants
const KidsPendantPage = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const url = new URL('https://rmj-backend.onrender.com/api/kids-pendants');
  ...
  return (
    <div className="pendant-listing">
      <div className="pendant-header">
        <h1>Magical Kids' Pendants</h1>
        <p className="pendant-subtitle">Fun and colorful treasures for your little ones</p>
      </div>

      <div className="pendant-banner">
        <h2>Adventure Awaits!</h2>
        <p>Every pendant tells a story. What adventure will your child choose?</p>
      </div>
      ...
      <div className="pendant-filter-sort-container">
        ...
        <div className="pendant-product-count">
          {filteredProducts.length} magical pendants
        </div>
      </div>
      ...
      <div className="pendant-promotion-banner">
        NICKEL-FREE JEWELRY | KID-SAFE MATERIALS | GIFT PACKAGING | NO-TANGLE CHAINS
      </div>

      <div className="pendant-features">
        <div className="pendant-feature">
          <div className="pendant-feature-icon">🌈</div>
          <div className="pendant-feature-text">Colorful & Fun</div>
        </div>
        <div className="pendant-feature">
          <div className="pendant-feature-icon">💧</div>
          <div className="pendant-feature-text">Water Resistant</div>
        </div>
        <div className="pendant-feature">
          <div className="pendant-feature-icon">🛡️</div>
          <div className="pendant-feature-text">Durable Design</div>
        </div>
        <div className="pendant-feature">
          <div className="pendant-feature-icon">🎁</div>
          <div className="pendant-feature-text">Gift Ready</div>
        </div>
      </div>

      <div className="pendant-testimonial">
        <div className="pendant-testimonial-text">
          "My daughter absolutely loves her Unicorn Pendant! She wears it everywhere and tells everyone about her magical unicorn friend. The quality is excellent and perfect for active kids!"
        </div>
        <div className="pendant-testimonial-author">- Meera Patel, Mumbai</div>
      </div>
    </div>
  );
};
...
// CSS styles with playful theme for kids' pendants
const styles = `
body {
  margin-top: 200px;
}
...
export default KidsPendantListing;