...
// Main Product Listing component for Men's Bracelets
const MensBraceletPage = () => {
 ...
 const fetchProducts = async () => {
  try {
    ...
    const url = new URL('https://rmj-backend.onrender.com/api/men-bracelets');
  ...
  return (
    <div className="bracelet-listing">
      <div className="bracelet-header">
        <h1>Men's Distinctive Bracelets</h1>
        <p className="bracelet-subtitle">Explore our collection of meticulously crafted bracelets for the modern man</p>
      </div>

      <div className="bracelet-banner">
        <h2>Strength in Every Link</h2>
        <p>Bold designs to complement your personal style.</p>
      </div>
      ...
      <div className="bracelet-filter-sort-container">
        ...
        <div className="bracelet-product-count">
          {filteredProducts.length} premium bracelets
        </div>
      </div>
      ...
      <div className="bracelet-promotion-banner">
        CUSTOM SIZING | PREMIUM MATERIALS | 2-YEAR WARRANTY | DISCREET PACKAGING
      </div>

      <div className="bracelet-features">
        <div className="bracelet-feature">
          <div className="bracelet-feature-icon">⚒️</div>
          <div className="bracelet-feature-text">Artisan Crafted</div>
        </div>
        <div className="bracelet-feature">
          <div className="bracelet-feature-icon">🛡️</div>
          <div className="bracelet-feature-text">Durable Materials</div>
        </div>
        <div className="bracelet-feature">
          <div className="bracelet-feature-icon">♻️</div>
          <div className="bracelet-feature-text">Sustainable Sourcing</div>
        </div>
        <div className="bracelet-feature">
          <div className="bracelet-feature-icon">📏</div>
          <div className="bracelet-feature-text">Perfect Fit Guarantee</div>
        </div>
      </div>

      <div className="bracelet-testimonial">
        <div className="bracelet-testimonial-text">
          "The Titanium Cuff Bracelet has become my everyday signature piece. The quality is exceptional and the design is understated yet distinctive. Perfect for both business and casual settings."
        </div>
        <div className="bracelet-testimonial-author">- Rajiv Mehta, Mumbai</div>
      </div>
    </div>
  );
};
...
// CSS styles with masculine theme for men's bracelets
const styles = `
body {
  margin-top: 200px;
}
...
export default MensBraceletListing;