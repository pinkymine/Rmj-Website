...
// Main Product Listing component for Men's Pendants
const MensPendantPage = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const url = new URL('https://rmj-backend.onrender.com/api/men-pendants');
  ...
  return (
    <div className="pendant-listing">
      <div className="pendant-header">
        <h1>Sophisticated Men's Pendants</h1>
        <p className="pendant-subtitle">Discover our collection of bold pendants that make a statement</p>
      </div>

      <div className="pendant-banner">
        <h2>Strength in Every Design</h2>
        <p>Each pendant represents character. Find the one that defines you.</p>
      </div>
      ...
      <div className="pendant-filter-sort-container">
        ...
        <div className="pendant-product-count">
          {filteredProducts.length} distinctive pendants
        </div>
      </div>
      ...
      <div className="pendant-promotion-banner">
        PREMIUM CHAINS INCLUDED | AUTHENTIC MATERIALS | LIFETIME WARRANTY | DISCREET PACKAGING
      </div>

      <div className="pendant-features">
        <div className="pendant-feature">
          <div className="pendant-feature-icon">🛡️</div>
          <div className="pendant-feature-text">Durable Construction</div>
        </div>
        <div className="pendant-feature">
          <div className="pendant-feature-icon">⚒️</div>
        ...
        <div className="pendant-feature">
          ...
          <div className="pendant-feature-text">Quality Assurance</div>
        </div>
        <div className="pendant-feature">
          <div className="pendant-feature-icon">🔗</div>
          <div className="pendant-feature-text">Premium Chains</div>
        </div>
      </div>

      <div className="pendant-testimonial">
        <div className="pendant-testimonial-text">
          "The Tungsten Arrow Pendant has become my signature piece. The craftsmanship is exceptional and the modern design pairs perfectly with both casual and formal attire. It's subtle yet distinctive."
        </div>
        <div className="pendant-testimonial-author">- Rahul Kapoor, Mumbai</div>
      </div>
    </div>
  );
};
...
// CSS styles with bold theme for men's pendants
const styles = `
body {
  margin-top: 200px;
}
...
export default MensPendantListing;